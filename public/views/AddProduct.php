    ...
    <body class="bg-slate-50">
        <header class="w-full p-2 bg-slate-900 text-slate-50">
       	...
       	<div class="container justify-center flex mx-auto mt-5">
       		<form id="addProduct" class="bg-white border rounded p-4 drop-shadow-md" action="../../src/entities/AddProduct.php" method="post">
       			...
       			<div class="w-64 flex flex-col">
       				<button class="cursor-pointer rounded-md p-1 border bg-blue-700 text-white" name="save" style="width: 16.3rem;">Save</button>
       			</div>
       		</form>
       	</div>
